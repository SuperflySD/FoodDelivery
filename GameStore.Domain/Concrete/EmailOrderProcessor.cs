...
namespace GameStore.Domain.Concrete
{
    ...
    {
        public string MailToAddress = "food@mail.ru";
        public string MailFromAddress = "food@mail.ru";
        public bool UseSsl = true;
        public string Username = "food";
        public string Password = "food";
        public string ServerName = "smtp.mail.ru";
        public int ServerPort = 587;
        public bool WriteAsFile = true;
        public string FileLocation = @"c:\films";
    }
